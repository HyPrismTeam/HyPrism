...
- **Linux:** Ubuntu 20.04+, Debian 11+, Fedora 35+, or any equivalent x64 distribution
- **macOS:** Monterey (12)+, Apple Silicon (arm64)
- Internet connection for first launch (authentication & game download)

Runtime note:
- HyPrism is a self-contained .NET 10 binary with Sciter bundled — no separate runtime installation is required.
