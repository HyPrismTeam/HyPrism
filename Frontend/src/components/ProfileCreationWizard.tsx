...
import {  User, Shield, ArrowLeft, Loader2, Dices, Check, AlertCircle, AlertTriangle  } from '../components/icons/LucideIcons';
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 w-full">
                            <input
                                type="text"
                                value={name}
                                onChange={(e) => { setName((e.target as HTMLInputElement).value); setError(null); }}
