...
import {  DownloadCloud, X  } from '../../components/icons/LucideIcons';
...
export const UpdateOverlay = memo(({ progress, downloaded, total, status, failed, onClose }: UpdateOverlayProps) => {
  const { t } = useI18n();
...
(UpdateOverlay as any).displayName = 'UpdateOverlay';
