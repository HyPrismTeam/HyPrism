...
import {  Home, Newspaper, Users, HardDrive, Settings, Volume2, VolumeX, type LucideIcon  } from '../../components/icons/LucideIcons';
...
export const DockMenu = ({ activePage, onPageChange, isMuted = false, onToggleMute }: DockMenuProps) => {
  const { accentColor } = useAccentColor();

  const { t } = useI18n();

  const dockStyle: Record<string, any> = {
