...
export interface ContentTabProps {
  ...
  handleOpenModPage: (e: React.MouseEvent<HTMLElement>, mod: ModInfo) => void;
}
...
export const ContentTab: React.FC<ContentTabProps> = ({
  ...
  const handleRowClick = useCallback((e: React.MouseEvent<HTMLElement>, modId: string, index: number) => {
    if (e.shiftKey) {
      e.preventDefault();
          ...
          <div className="p-4 border-b border-white/[0.06] flex items-center gap-3">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                onChange={(e) => setModsSearchQuery((e.target as HTMLInputElement).value)}
                onKeyDown={(e) => {
