...
import {  Info, Power, Plus, Trash2, Loader2, Globe, AlertCircle, RefreshCw, X, Check  } from '../../../components/icons/LucideIcons';
              ...
              <div className="p-4 bg-white/[0.02] border-b border-white/[0.06] space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    value={newMirrorUrl}
                    onChange={(e) => { setNewMirrorUrl((e.target as HTMLInputElement).value); setAddError(null); }}
                ...
                <div className="space-y-1.5">
                  <input
                    ...
                    onChange={(e) => setNewMirrorHeaders((e.target as HTMLInputElement).value)}
