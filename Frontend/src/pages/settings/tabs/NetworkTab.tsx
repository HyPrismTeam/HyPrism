...
import {  Wifi, Server, Globe, Edit3, CheckCircle, XCircle, Loader2, AlertTriangle, RefreshCw  } from '../../../components/icons/LucideIcons';
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      onChange={(e) => setCustomAuthDomain((e.target as HTMLInputElement).value)}
                      onKeyDown={async (e) => {
